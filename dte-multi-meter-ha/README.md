...
This repository includes HACS/Home Assistant brand assets in the `brand/` folder:
...
`icon.png` is the required HACS custom integration icon asset. `dte.svg` is kept as the source artwork.
